    ...
    if results.detections:
        for detection in results.detections:
            ...
            if label == "Mask" and prev_state != 'M':
                arduino.write(b'M')  # Send 'M' to Arduino for mask detected
                prev_state = 'M'
            elif label == "No Mask" and prev_state != 'N':
                arduino.write(b'N')  # Send 'N' to Arduino for no mask detected
                prev_state = 'N'
            ...
            # Send X coordinate to Arduino
            arduino.write(f"{startX}\n".encode())
